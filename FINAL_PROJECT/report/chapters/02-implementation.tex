...
La \figref{sequence-sendmessage-rest} illustre le flux complet d'un envoi de message en phase REST, depuis le navigateur jusqu'à l'insertion en base, en passant par le middleware d'authentification et l'appel inter-service vers Jersey. La composition de services y est observable directement.
